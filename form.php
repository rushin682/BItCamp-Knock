...
if(isset($_POST['submit'])){
	...
	if($pwd==$cpwd){
		$sql = "INSERT INTO patient (Gender,FirstName,LastName,username,Password,Contact,Email,DOB,Bloodgroup,Allergies,Street1,Street2,State,City,Pincode,History,FamilyHistory) VALUES ('$gen','$fn','$ln','$un','$pwd','$con','$em','$dob','$bg','$al','$st1','$st2','$st','$ct','$pin','$mh','$fh')";
		...
		if ($conn->query($sql) === TRUE ) {
			...
			session_start();
			$_SESSION['login_username']=$_POST['un'];
			echo "<script type='text/javascript'>window.location.href = 'online.php';</script>";			
            ...
            <form method="post" action="" novalidate>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2">
                        <div class="step1">
							...
							<div class="row">
                                ...
                                <input type="text" class="form-control" id="bg" name="bg" placeholder="Blood Group">
                            </div>
                            </div>
							<div class="row">
                                <div class="col-md-6">
                                <label>Allergies</label>
                                <input type="text" class="form-control" id="allergy" name="allergy" placeholder="Allergies">
                            </div>
                            </div>
							<hr>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step3">
                        <div class="step1">
                        <center><h4>Medical History</h4></center>
										<div class="row ">
											<div class="col-sm-12 fields">
												<label>Medical History</label> <input id="history"
													type="text" name="history" class="form-control"
													placeholder="All past history"
											...
											<div class="row">
												<div class="col-md-6">
													...
													<input type="text" class="form-control" id="fhist" name="fhist" placeholder="All past history">
												</div>
											</div>
											<div class="row">
												<div class="col-md-6">
													<label>Attach previous medical records</label>
